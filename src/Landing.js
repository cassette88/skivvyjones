...
export default class Landing extends Component {
  ...
  render() {
    return (
      ...
      <img src="https://img.youtube.com/vi/qIeCZQemTC0/default.jpg"/>
      </div>
      </div>
      <div className="col-lg-4 col-md-6 col-sm-6">
      <p>Beach House</p>      
      <div className="youtube-player" data-id="PHbtR8uO81M">
      <img src="https://img.youtube.com/vi/PHbtR8uO81M/default.jpg"/>
      </div>
      </div>
      <div className="col-lg-4 col-md-6 col-sm-6">
      <p>Atlas Sound</p>
      <div className="youtube-player" data-id="ZBtW5WTb0qE">
      <img src="https://img.youtube.com/vi/ZBtW5WTb0qE/default.jpg"/>
      </div>
      </div>
